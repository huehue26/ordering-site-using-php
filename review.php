    ...
    <section class="py-5">
      <div class="container">
          ...
          <div class="col-md-5" id="contact_form">
            <div class="form-area">
              <form role="form">
                ...
                <div class="form-group">
                  <textarea class="form-control" type="textarea" id="message" placeholder="Comment Here" maxlength="140" rows="7"></textarea>
        ...
        <footer class="py-5 bg-dark">
          <div class="container">
            <p class="m-0 text-center text-white">Copyright &copy; Site 2021</p>
          </div>
          <!-- /.container -->
        </footer>
...
<script type="text/javascript" src="vendor/custom/js/review.js"></script>
<script>
  $('#star1').starrr({
